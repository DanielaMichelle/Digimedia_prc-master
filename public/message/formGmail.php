...
function SendMessage($menssage,$imagenes_main,$title){
    if($_POST){
        ...
        $header = "From: pruebadigi@ghx.umd.mybluehost.me\r\n";//pones aqui el correo del remitente
...
SendMessage($menssage[0][$id-1],$imagenes_main[0][$id-1],$title[0][$id-1]);
SendMessage($menssage[1][$id-1],$imagenes_main[1][$id-1],$title[1][$id-1]);
SendMessage($menssage[2][$id-1],$imagenes_main[2][$id-1],$title[2][$id-1]);
?>