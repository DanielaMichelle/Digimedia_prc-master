...
<script>
    ...
    let widthScreenToService4 = window.innerWidth;
    const imgSocialBrandingHero = document.querySelector(".hero-branding-img");
    if (widthScreenToService4 <= 426) {
        imgSocialBrandingHero.setAttribute('src', './public/img/branding3.webp');
    } else {
        imgSocialBrandingHero.setAttribute('src', './public/img/branding.webp');
    }
</script>