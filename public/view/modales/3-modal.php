<style>
    .contenedor-form{position:fixed;display:none;align-items:center;justify-content:center;transform:translate(-50%,-50%);top:52%;left:50%;z-index:4000;background:rgb(255 0 128 / .8);justify-content:space-between;border-radius:40px;padding:20px}.btn-cerrar{position:absolute;right:10px;top:7px;background-color:#DF1A82;width:40px;height:40px;display:grid;align-items:center;justify-content:center;border-radius:50%;border:3px solid #fff;i{font-size:x-large}i:hover{cursor:pointer}}.resgistration-style__frase h2{color:#fff;font-size:2vw}.btn-cerrar i{display:flex;justify-content:right;cursor:pointer}.resgistration-style__anum{color:#000;font-size:1.3vw;text-align:center}.letrero{background:#fff0;width:400px;padding:2px;text-align:center}.letrero h2{color:#fff;padding:2px 2px;font-size:2.1vw;text-shadow:-1px -1px 0 #000,1px -1px 0 #000,-1px 1px 0 #000,1px 1px 0 #000}.resgistration-style{display:flex;background:#fff0;flex-direction:column;justify-content:center;align-items:center}.resgistration-style__div>img{width:250px;height:240px;padding:10px;background:#fff;border-radius:20px}.registration-form.inactive{display:none}.desktop-contact.inactive{display:none}.form-group input{border:1.6px solid #df76d5;font-size:1vw;border-bottom-left-radius:20px;border-bottom-right-radius:20px;border-top-left-radius:20px;border-top-right-radius:20px;margin-bottom:5px}.form-group textarea{resize:none;border:10px solid #df76d5}.form-group label{color:#fff;font-weight:500;font-size:1.4vw;margin-bottom:8px}.registration-form{margin:-40px 5px 6px}.registration-form form{opacity:1;padding:30px;border-radius:20px 20px 0 0;height:auto;width:350px;margin:5px 10px}.go-button{background:rgba(0,155,255,2);width:100%;color:#fff;font-family:Arial,Helvetica,sans-serif;font-weight:500;border-radius:3px;cursor:pointer;padding:5px 7px;border:none;font-size:1.7vw;margin-top:20px;border-bottom-left-radius:20px;border-bottom-right-radius:20px;border-top-left-radius:20px;border-top-right-radius:20px}.btn-mobile{top:562px;display:flex;justify-content:flex-end;position:fixed;opacity:0}.btn-mobile.inactive{display:none}.btn-mobile button{width:75px;height:75px;border-radius:40px;background:#FF0080}.btn-mobile button img{width:45px;height:45px}.ocultar{display:block}.letrero-movil{display:none}@media only screen and (max-width:913px){.contenedor-form{width:75%;justify-content:center;display:flex;flex-direction:column;height:auto;padding-bottom:10px}.ocultar{display:none}.btn-mobile{right:4%;opacity:1}.resgistration-style{display:none}.registration-form{width:100%;height:80%;position:relative;bottom:0;background:#fff0;padding:0;top:0}.registration-form form{background:#fff0;width:100%;height:100%}.registration-form label{font-size:2.3vw}.registration-form input{font-size:2.3vw;width:100%}.go-button{width:95%;font-size:2.4vw}.letrero-movil{display:block;width:100%;color:#fff;font-weight:100;text-align:center}.letrero-movil h2{font-size:4vw}.btn-cerrar{top:-5px;right:-6px;z-index:95000;width:34px;height:34px}}.overflow{z-index:3000;background-color:rgb(0 0 0 / .5);width:100%;height:100%;display:none;position:fixed;top:0;left:0;right:0;bottom:0}
</style>
