<style>
    .contenedor-form{position:fixed;display:none;align-items:center;justify-content:center;transform:translate(-50%,-50%);top:55%;left:50%;margin:auto;z-index:4000;background:rgb(0 155 255 / .9);flex-wrap:wrap;justify-content:space-between;border-radius:40px}.btn-cerrar{position:absolute;right:10px;top:7px;background-color:skyblue;width:40px;height:40px;display:grid;align-items:center;justify-content:center;border-radius:50%;border:3px solid #fff;i{font-size:x-large}i:hover{cursor:pointer}}.resgistration-style__frase h2{color:#fff;font-size:1.3vw}.btn-cerrar i{display:flex;justify-content:right;cursor:pointer}.resgistration-style__anum{color:#fff;text-align:center;position:relative;font-weight:700;font-size:2vw}.resgistration-style__anum::after{content:" ";position:absolute;width:100%;height:3px;background:#fff;bottom:0;left:0}.resgistration-style__anum:hover{color:#D6D9D6}.resgistration-style__anum:hover::after{background:#D6D9D6}.letrero{background:#fff0;margin:2px;width:850px}.letrero h2{color:#fff;text-shadow:-1px -1px 0 #000,1px -1px 0 #000,-1px 1px 0 #000,1px 1px 0 #000;padding:20px 20px;font-size:3.5vw;font-weight:700;text-align:center}.resgistration-style{padding:20px;margin:-60px 15px 2px 80px;display:flex;flex-direction:column;justify-content:center;align-items:center}.resgistration-style__div>img{width:263px;height:193px}.registration-form.inactive{display:none}.desktop-contact.inactive{display:none}.form-group input{border:1.6px solid #df76d5;font-size:1vw;border-bottom-left-radius:20px;border-bottom-right-radius:20px;border-top-left-radius:20px;border-top-right-radius:20px;margin-bottom:5px}.form-group textarea{resize:none;border:10px solid #df76d5}.form-group label{color:#fff;font-weight:500;font-size:1.4vw;margin-bottom:8px}.registration-form{margin:-60px 39px 6px}.registration-form form{opacity:1;padding:30px;border-radius:20px 20px 0 0;height:auto;width:350px;margin:5px 10px}.go-button{background:purple;width:100%;color:#fff;font-family:Arial,Helvetica,sans-serif;font-weight:500;border-radius:3px;cursor:pointer;padding:5px 7px;border:none;font-size:1.7vw;border-bottom-left-radius:20px;border-bottom-right-radius:20px;border-top-left-radius:20px;border-top-right-radius:20px}.btn-mobile{top:562px;display:none;justify-content:flex-end;position:fixed;opacity:0}.btn-mobile.inactive{display:none}.btn-mobile button img{width:45px;height:45px}.ocultar{display:block}@media only screen and (max-width:913px){.contenedor-form{width:75%;display:flex;flex-direction:column;background:rgb(0 155 255 / .9)}.ocultar{display:none}.resgistration-style{display:none}.letrero{width:100%;background:#fff0;margin:0;padding:0 10px}.letrero h2{font-size:3.3vw}.btn-mobile{right:4%;opacity:1}.registration-form{margin:0;background:#fff0;width:100%;padding:0}.registration-form form{width:100%;height:100%;position:relative;left:0;top:-40px}.registration-form form input{width:98%;font-size:2.5vw;margin-bottom:10px}.registration-form form label{font-size:2.5vw;margin-bottom:10px;margin-top:0}.go-button{width:98%;font-size:2.5vw;margin-top:15px}.btn-cerrar{top:-5px;right:-6px;z-index:95000;width:34px;height:34px}}.overflow{z-index:3000;background-color:rgb(0 0 0 / .5);width:100%;height:100%;display:none;position:fixed;top:0;left:0;right:0;bottom:0}
</style>
