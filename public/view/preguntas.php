...
<body>
    ...
    <div class="red">
        <div id="facebook"><a href="https://www.facebook.com/DigiMedia.Marketing1" title="Nuestro Facebook!" target="_blank"><img alt="Img no encontrada..." title="Facebook" src="./public/img/fb.webp"></a></div>
        <div id="instagram"><a href="https://www.instagram.com/digimediamkt/" title="Nuestro Instagram! target=" _blank"><img alt="Img no encontrada..." title="Instagram" src="./public/img/ig.webp"></a></div>
        <div id="twitter"><a href="https://pe.linkedin.com/in/digimedia-marketing?trk=public_post_feed-actor-name" title="Nuestro Linkedin!"><img alt="Img no encontrada..." title="Linkedin" src="./public/img/tw.webp"></a></div>
    </div>
            ...
            <div class="question">
                ...
                <div class="answer" style="display: none;">
                    <p>Existe una gran variedad de herramientas de marketing en redes sociales disponibles para ayudar a
                        ...
                        el marketing de influencers, el marketing de anuncios y la anal&iacute;tica. Cada una de estas herramientas
                        tienen sus propias ventajas y desventajas, por lo que es importante seleccionar las que mejor se adapten a las necesidades de la empresa.</p>
                </div>
            </div>
            <div class="question">
